 ...
 * Last generated by Orchestration Designer at: 2023-FEB-01  04:00:37 PM
 */
public class AvailableBranches extends com.avaya.sce.runtime.Form {
	...
	public java.util.Collection getPrompts(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		list.add(new com.avaya.sce.runtime.PromptRefInfo("AvailableBranches", ""));
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		submit = new com.avaya.sce.runtime.Submit("GetBloodUnits-exit");
		return submit;
	}
	/**
	...
	public java.util.Collection getTrackingActions(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		list.add(new com.avaya.sce.runtime.tracking.TraceInfo(com.avaya.sce.runtimecommon.ITraceInfo.TRACE_LEVEL_INFO, "Entered  AvailableBranches node", ""));
		return(list);
	}
	/**
	 ...
	 * by the code generator based on items in the call flow editor.
	 * This method should not be manually edited as changes may be
	 * overwritten by the code generator.  <br>Last generated by Orchestration Designer at: 2023-FEB-20  06:32:07 PM
	 */
	...
	public void requestBegin(SCESession mySession) {
		...
		try {
			...
			availablebranchlist =(ArrayList<String>) mySession.getVariableField(IProjectVariables.API_RESULTS, IProjectVariables.API_RESULTS_FIELD_AVAILABLE_BRANCHES)
					 .getObjectValue();
	...
	public void updatePrompts(Collection prompts, SCESession mySession) {
		...
		for (int i = 0; i < availablebranchlist.size(); i++) {
