...
public class SelectBlood_group extends com.avaya.sce.runtime.Menu {
	...
	public java.util.Collection getEvents(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		event = new com.avaya.sce.runtime.Event(com.avaya.sce.runtimecommon.SCERT.EVENT_NOINPUT, (com.avaya.sce.runtime.PromptRefInfo[])eventPromptNames.toArray(new com.avaya.sce.runtime.PromptRefInfo[0]), new com.avaya.sce.runtime.Goto("GetBloodUnits-NoInputBloodGroup", 3, true, ""));
		list.add(event);
		...
		event = new com.avaya.sce.runtime.Event(com.avaya.sce.runtimecommon.SCERT.EVENT_NOMATCH, (com.avaya.sce.runtime.PromptRefInfo[])eventPromptNames.toArray(new com.avaya.sce.runtime.PromptRefInfo[0]), new com.avaya.sce.runtime.Goto("GetBloodUnits-NoMatchBloodGroup", 3, true, ""));
		list.add(event);
		return(list);
	}
	/**
	...
	public void requestBegin(SCESession mySession) {
		TraceInfo.trace(ITraceInfo.TRACE_LEVEL_INFO,"Entered Select Blood Group Node", mySession);
	...
	public void updateChoices(Collection choices, SCESession mySession) {
		...
		try {
			...
			for (int i = 0; i < bloodGrouplist.size(); i++) {
				...
				choice = new com.avaya.sce.runtime.Choice(bloodgroup, dtmf, true, "exact", "GetBloodUnits-AvailableBranchesAPI", grammarInfo, true);
				choices.add(choice);
