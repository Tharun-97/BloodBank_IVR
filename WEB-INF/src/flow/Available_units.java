 ...
 * executing Last generated by Orchestration Designer at: 2023-FEB-01 12:03:21
 * PM
 */
public class Available_units extends com.avaya.sce.runtime.Form {
	...
	public java.util.Collection getPrompts(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		list.add(new com.avaya.sce.runtime.PromptRefInfo("AvailableUnits", ""));
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		submit = new com.avaya.sce.runtime.Submit("Thanks");
		return submit;
	}
	 ...
	 * by the code generator based on items in the call flow editor.
	 * This method should not be manually edited as changes may be
	 * overwritten by the code generator.  <br>Last generated by Orchestration Designer at: 2023-FEB-17  06:39:35 PM
	 */
	...
	public void requestBegin(SCESession mySession) {
		TraceInfo.trace(ITraceInfo.TRACE_LEVEL_INFO, "Entered available units node", mySession);
		
		mySession.getVariableField(IProjectVariables.CALL__HISTORY, IProjectVariables.CALL__HISTORY_FIELD_EXITNODE).setValue("Available Units Node");

		mySession.getVariableField(IProjectVariables.CALL__HISTORY, IProjectVariables.CALL__HISTORY_FIELD_EXITREASON).setValue("Success");
		...
		String bloodgroupid = mySession
				.getVariableField(IProjectVariables.BLOOD__GROUP, IProjectVariables.BLOOD__GROUP_FIELD_VALUE)
				.getStringValue();

		try {
			availableunits = api.ApiIntegrationValue(
					"http://172.16.11.88:8010/BloodBank/bloodGroups/getAvailableUnits/" + branch + "/" + bloodgroupid);
	...
	public void updatePrompts(Collection prompts, SCESession mySession) {
		...
		try {
			TraceInfo.trace(ITraceInfo.TRACE_LEVEL_INFO, "Update Available Units prompt Start", mySession);
			Prompt p = new Prompt() {
				@Override
			...
			if (availableunits==null) {
				TraceInfo.trace(ITraceInfo.TRACE_LEVEL_INFO,availableunits, mySession);
				p.add(1, new com.avaya.sce.runtime.PhraseVariableElement("AudioURLs:NoUnits",com.avaya.sce.runtime.PhraseVariableElement.Type.AUDIO_URL, false));
				prompts.add(p);
			}
			else {
				TraceInfo.trace(ITraceInfo.TRACE_LEVEL_INFO,availableunits+"Available Units prompt working", mySession);

				mySession.getVariableField(IProjectVariables.AVAILABLE_UNITS,IProjectVariables.AVAILABLE_UNITS_FIELD_UNITS).setValue(availableunits);
		...
		TraceInfo.trace(ITraceInfo.TRACE_LEVEL_INFO, "Update Available Units prompt End", mySession);
	}
}
