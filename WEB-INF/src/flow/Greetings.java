 ...
 * Last generated by Orchestration Designer at: 2023-JAN-23  12:50:19 PM
 */
public class Greetings extends com.avaya.sce.runtime.Form {
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		submit = new com.avaya.sce.runtime.Submit("ServiceSelect");
		return submit;
	}
	/**
	...
	public void updatePrompts(Collection prompts, SCESession mySession) {
		...
		p.add(1, new com.avaya.sce.runtime.PhraseVariableElement("AudioURLs:Greetings",com.avaya.sce.runtime.PhraseVariableElement.Type.AUDIO_URL, false));
		prompts.add(p);
