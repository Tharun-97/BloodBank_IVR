...
public class BranchSelection extends com.avaya.sce.runtime.Menu {
	...
	public void updatePrompts(Collection prompts, SCESession mySession) {
		...
		if (branchlist==null) {
			...
			p.add(1, new com.avaya.sce.runtime.PhraseVariableElement("AudioURLs:Exit",com.avaya.sce.runtime.PhraseVariableElement.Type.AUDIO_URL, false));
			prompts.add(p);
		...
		try {
			...
			if (branchlist==null) {
				choice = new com.avaya.sce.runtime.Choice("NoBranch", "1", true, "exact", "RegionSelection",
						grammarInfo, true);
				choices.add(choice);
				choice = new com.avaya.sce.runtime.Choice("Exit", "0", true, "exact", "Thanks",
						grammarInfo, true);
				choices.add(choice);
			}
