...
public class RegionSelection extends com.avaya.sce.runtime.Menu {
	...
	public void updatePrompts(Collection prompts, SCESession mySession) {
		...
		for (int i = 0; i < regionlist.size(); i++) {
			...
			if (dtmf.equals("1")) {
				 mySession.getVariableField(IProjectVariables.CHOICE_URLS,IProjectVariables.CHOICE_URLS_FIELD_CHOICE_1).setValue("D:\\IVR Audios\\BloodBank\\"+region+".wav");	
				
				p.add(1, new com.avaya.sce.runtime.PhraseVariableElement("ChoiceURLs:Choice1",
						com.avaya.sce.runtime.PhraseVariableElement.Type.AUDIO_URL, false));
			}else if (dtmf.equals("2")) {
				 mySession.getVariableField(IProjectVariables.CHOICE_URLS,IProjectVariables.CHOICE_URLS_FIELD_CHOICE_2).setValue("D:\\IVR Audios\\BloodBank\\"+region+".wav");	
					
					p.add(1, new com.avaya.sce.runtime.PhraseVariableElement("ChoiceURLs:Choice2",
							com.avaya.sce.runtime.PhraseVariableElement.Type.AUDIO_URL, false));
			}else if (dtmf.equals("3")) {
				 mySession.getVariableField(IProjectVariables.CHOICE_URLS,IProjectVariables.CHOICE_URLS_FIELD_CHOICE_3).setValue("D:\\IVR Audios\\BloodBank\\"+region+".wav");	
					
					p.add(1, new com.avaya.sce.runtime.PhraseVariableElement("ChoiceURLs:Choice3",
							com.avaya.sce.runtime.PhraseVariableElement.Type.AUDIO_URL, false));
			}else if (dtmf.equals("4")) {
				 mySession.getVariableField(IProjectVariables.CHOICE_URLS,IProjectVariables.CHOICE_URLS_FIELD_CHOICE_4).setValue("D:\\IVR Audios\\BloodBank\\"+region+".wav");	
					
					p.add(1, new com.avaya.sce.runtime.PhraseVariableElement("ChoiceURLs:Choice4",
							com.avaya.sce.runtime.PhraseVariableElement.Type.AUDIO_URL, false));
			}else if (dtmf.equals("5")) {
				 mySession.getVariableField(IProjectVariables.CHOICE_URLS,IProjectVariables.CHOICE_URLS_FIELD_CHOICE_5).setValue("D:\\IVR Audios\\BloodBank\\"+region+".wav");	
					
					p.add(1, new com.avaya.sce.runtime.PhraseVariableElement("ChoiceURLs:Choice5",
							com.avaya.sce.runtime.PhraseVariableElement.Type.AUDIO_URL, false));
			}else if (dtmf.equals("6")) {
				 mySession.getVariableField(IProjectVariables.CHOICE_URLS,IProjectVariables.CHOICE_URLS_FIELD_CHOICE_6).setValue("D:\\IVR Audios\\BloodBank\\"+region+".wav");	
