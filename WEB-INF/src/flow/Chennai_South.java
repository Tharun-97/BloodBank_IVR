 ...
 * Last generated by Orchestration Designer at: 2023-JAN-19  04:48:57 PM
 */
public class Chennai_South extends com.avaya.sce.runtime.Menu {
	 ...
	 * Last generated by Orchestration Designer at: 2023-FEB-10  12:00:06 PM
	...
	public java.util.Collection getPrompts(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		list.add(new com.avaya.sce.runtime.PromptRefInfo("SouthZone", ""));
	...
	public void requestBegin(SCESession mySession) {
		TraceInfo.trace(ITraceInfo.TRACE_LEVEL_INFO, "Entered Chennai_South Region Node", mySession);
	...
	public void updatePrompts(Collection prompts, SCESession mySession) {
		...
		for (int i = 0; i < branchlist.size(); i++) {
			...
			p.add(1, new com.avaya.sce.runtime.PhraseVariableElement("AudioURLs:"+branch+"",com.avaya.sce.runtime.PhraseVariableElement.Type.AUDIO_URL, false));
		...
		p.add(1, new com.avaya.sce.runtime.PhraseVariableElement("AudioURLs:Repeat",com.avaya.sce.runtime.PhraseVariableElement.Type.AUDIO_URL, false));
				...
				if (PageNumber == 0) {
					...
					for (int i = PageNumber * 6; i < (PageNumber * 6) + 6; i++) {
						...
						p.add(1, new com.avaya.sce.runtime.PhraseVariableElement("DTMFaudio:Press"+dtmf+"",com.avaya.sce.runtime.PhraseVariableElement.Type.AUDIO_URL, false));
	...
	public void updateChoices(Collection choices, SCESession mySession) {
		try {
			...
			if (menupage == 1) {
				...
				choice = new com.avaya.sce.runtime.Choice("Repeat", "8", true, "exact", "ChoiceProcessing2", grammarInfo,
						true);
				choices.add(choice);
				...
				if (PageNumber == 0) {
					...
					choice = new com.avaya.sce.runtime.Choice("Repeat", "8", true, "exact", "ChoiceProcessing2",grammarInfo, true);
					choices.add(choice);
					choice = new com.avaya.sce.runtime.Choice("NextMenuPage", "9", true, "exact", "ChoiceProcessing2",grammarInfo, true);
					choices.add(choice);
				} 
				else if (PageNumber == menupage - 1) {
					for (int i = PageNumber * 6; i < branchlist.size(); i++) {
					...
					choice = new com.avaya.sce.runtime.Choice("PreviousMenuPage", "7", true, "exact", "ChoiceProcessing2",grammarInfo, true);
					choices.add(choice);
					choice = new com.avaya.sce.runtime.Choice("Repeat", "8", true, "exact", "ChoiceProcessing2",
							grammarInfo, true);
					choices.add(choice);
				}
				else {
					...
					choice = new com.avaya.sce.runtime.Choice("PreviousMenuPage", "7", true, "exact", "ChoiceProcessing2",
							grammarInfo, true);
					choices.add(choice);
					choice = new com.avaya.sce.runtime.Choice("Repeat", "8", true, "exact", "ChoiceProcessing2",
							grammarInfo, true);
					choices.add(choice);
					choice = new com.avaya.sce.runtime.Choice("NextMenuPage", "9", true, "exact", "ChoiceProcessing2",
							grammarInfo, true);
