 ...
 * PM
 */
public class Chennai_North extends com.avaya.sce.runtime.Menu {
	...
	public void requestBegin(SCESession mySession) {
		TraceInfo.trace(ITraceInfo.TRACE_LEVEL_INFO, "Entered Chennai_North Region Node", mySession);
	...
	public void updatePrompts(Collection prompts, SCESession mySession) {
		...
		try {
			TraceInfo.trace(ITraceInfo.TRACE_LEVEL_INFO,"Update Chennai North prompt Start", mySession);
		Prompt p = new Prompt() {
			@Override
		...
		p.add(1, new com.avaya.sce.runtime.PhraseVariableElement("AudioURLs:Repeat",com.avaya.sce.runtime.PhraseVariableElement.Type.AUDIO_URL, false));
			...
			TraceInfo.trace(ITraceInfo.TRACE_LEVEL_INFO,"Update Chennai north prompt End", mySession);
	...
	public void updateChoices(Collection choices, SCESession mySession) {
		try {
			...
			if (menupage == 1) {
				...
				choice = new com.avaya.sce.runtime.Choice("Repeat", "8", true, "exact", "ChoiceProcessing1",
						grammarInfo, true);
				choices.add(choice);
				...
				if (PageNumber == 0) {
					...
					choice = new com.avaya.sce.runtime.Choice("Repeat", "8", true, "exact", "ChoiceProcessing1",
							grammarInfo, true);
					choices.add(choice);
					choice = new com.avaya.sce.runtime.Choice("NextMenuPage", "9", true, "exact", "ChoiceProcessing1",
							grammarInfo, true);
					choices.add(choice);
				} else if (PageNumber == menupage - 1) {
					for (int i = PageNumber * 6; i < branchlist.size(); i++) {
					...
					choice = new com.avaya.sce.runtime.Choice("PreviousMenuPage", "7", true, "exact",
							"ChoiceProcessing1", grammarInfo, true);
					choices.add(choice);
					choice = new com.avaya.sce.runtime.Choice("Repeat", "8", true, "exact", "ChoiceProcessing1",
							grammarInfo, true);
					choices.add(choice);
