...
public class BranchAPI extends com.avaya.sce.runtime.Data {
	...
	public void requestBegin(SCESession mySession) {
		...
		try {
			...
			List<String> branchlist = api.ApiIntegrationList("http://172.16.11.88:8010/BloodBank/branches/listOfBranchByRegionId/" + dtmfInput,
					"branchLocation");
			TraceInfo.trace(ITraceInfo.TRACE_LEVEL_INFO,"Branch List: "+branchlist , mySession);

			if (branchlist==null) {
				mySession.getVariableField(IProjectVariables.API_RESULTS, IProjectVariables.API_RESULTS_FIELD_BRANCH_LIST).setValue(1);
	
			}else {
				mySession.getVariableField(IProjectVariables.API_RESULTS, IProjectVariables.API_RESULTS_FIELD_BRANCH_LIST).setValue(branchlist);

			}
			
		}
		catch (Exception e) {
			TraceInfo.trace(ITraceInfo.TRACE_LEVEL_ERROR,"Error occoured in getting branch List: "+e.getMessage(), mySession);
