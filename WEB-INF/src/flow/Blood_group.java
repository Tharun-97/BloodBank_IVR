 ...
 * executing Last generated by Orchestration Designer at: 2023-JAN-23 12:53:30
 * PM
 */
public class Blood_group extends com.avaya.sce.runtime.Menu {
	...
	public java.util.Collection getPrompts(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		list.add(new com.avaya.sce.runtime.PromptRefInfo("BloodGroup", ""));
	...
	public void requestBegin(SCESession mySession) {
		TraceInfo.trace(ITraceInfo.TRACE_LEVEL_INFO,"Entered Blood group Select Node", mySession);
		
		mySession.getVariableField(IProjectVariables.CALL__HISTORY, IProjectVariables.CALL__HISTORY_FIELD_EXITNODE).setValue("BloodGroup Selection Node");
	...
	public void updatePrompts(Collection prompts, SCESession mySession) {
		...
		try {
			TraceInfo.trace(ITraceInfo.TRACE_LEVEL_INFO,"Update Blood group Prompt Start", mySession);
			...
			if (dtmf.equals("1")) {
				 mySession.getVariableField(IProjectVariables.CHOICE_URLS,IProjectVariables.CHOICE_URLS_FIELD_CHOICE_1).setValue("D:\\IVR Audios\\BloodBank\\"+bloodgroup+".wav");	
				 ...
				 p.add(1, new com.avaya.sce.runtime.PhraseVariableElement("ChoiceURLs:Choice1",
					 ...
					 mySession.getVariableField(IProjectVariables.CHOICE_URLS,IProjectVariables.CHOICE_URLS_FIELD_CHOICE_2).setValue("D:\\IVR Audios\\BloodBank\\"+bloodgroup+".wav");	
						
					  p.add(1, new com.avaya.sce.runtime.PhraseVariableElement("ChoiceURLs:Choice2",
							    com.avaya.sce.runtime.PhraseVariableElement.Type.AUDIO_URL, false));
				
				}else if (dtmf.equals("3")) {
					 mySession.getVariableField(IProjectVariables.CHOICE_URLS,IProjectVariables.CHOICE_URLS_FIELD_CHOICE_3).setValue("D:\\IVR Audios\\BloodBank\\"+bloodgroup+".wav");	
					
					 p.add(1, new com.avaya.sce.runtime.PhraseVariableElement("ChoiceURLs:Choice3",
								com.avaya.sce.runtime.PhraseVariableElement.Type.AUDIO_URL, false));
				
				}else if (dtmf.equals("4")) {
					 mySession.getVariableField(IProjectVariables.CHOICE_URLS,IProjectVariables.CHOICE_URLS_FIELD_CHOICE_4).setValue("D:\\IVR Audios\\BloodBank\\"+bloodgroup+".wav");	
					
					 p.add(1, new com.avaya.sce.runtime.PhraseVariableElement("ChoiceURLs:Choice4",
								com.avaya.sce.runtime.PhraseVariableElement.Type.AUDIO_URL, false));
				
				}else if (dtmf.equals("5")) {
					 mySession.getVariableField(IProjectVariables.CHOICE_URLS,IProjectVariables.CHOICE_URLS_FIELD_CHOICE_5).setValue("D:\\IVR Audios\\BloodBank\\"+bloodgroup+".wav");	
					
					 p.add(1, new com.avaya.sce.runtime.PhraseVariableElement("ChoiceURLs:Choice5",
								com.avaya.sce.runtime.PhraseVariableElement.Type.AUDIO_URL, false));
				
				}else if (dtmf.equals("6")) {
					 mySession.getVariableField(IProjectVariables.CHOICE_URLS,IProjectVariables.CHOICE_URLS_FIELD_CHOICE_6).setValue("D:\\IVR Audios\\BloodBank\\"+bloodgroup+".wav");	
		...
		TraceInfo.trace(ITraceInfo.TRACE_LEVEL_INFO,"Update Blood group Prompt End", mySession);
	...
	public void updateChoices(Collection choices, SCESession mySession) {
		...
		try {
			TraceInfo.trace(ITraceInfo.TRACE_LEVEL_INFO,"Update Blood group Choice Start", mySession);
			...
			try {
				...
				for (int i = 0; i < bloodGrouplist.size(); i++) {
					...
					choice = new com.avaya.sce.runtime.Choice(bloodgroup, dtmf, true, "exact", "BranchSelect",
							grammarInfo, true);
					choices.add(choice);
		...
		TraceInfo.trace(ITraceInfo.TRACE_LEVEL_INFO,"Update Blood group choice End", mySession);
