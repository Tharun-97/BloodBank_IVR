...
public class Blood_group extends com.avaya.sce.runtime.Menu {
	...
	public java.util.Collection getEvents(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		event = new com.avaya.sce.runtime.Event(com.avaya.sce.runtimecommon.SCERT.EVENT_NOINPUT, (com.avaya.sce.runtime.PromptRefInfo[])eventPromptNames.toArray(new com.avaya.sce.runtime.PromptRefInfo[0]), new com.avaya.sce.runtime.Goto("NoInputBloodGroup", 3, true, ""));
		list.add(event);
		...
		event = new com.avaya.sce.runtime.Event(com.avaya.sce.runtimecommon.SCERT.EVENT_NOMATCH, (com.avaya.sce.runtime.PromptRefInfo[])eventPromptNames.toArray(new com.avaya.sce.runtime.PromptRefInfo[0]), new com.avaya.sce.runtime.Goto("NoMatchBloodGroup", 3, true, ""));
		list.add(event);
		return(list);
	}
	...
	public void requestBegin(SCESession mySession) {
		...
		try {
			bloodGrouplist=(ArrayList<String>) mySession.getVariableField(IProjectVariables.API_RESULTS, IProjectVariables.API_RESULTS_FIELD_BLOOD_GROUP_LIST).getObjectValue();
			
			TraceInfo.trace(ITraceInfo.TRACE_LEVEL_INFO,"BloodGroup List added:"+bloodGrouplist, mySession);
		...
		try {
			...
			try {
				...
				for (int i = 0; i < bloodGrouplist.size(); i++) {
					...
					choice = new com.avaya.sce.runtime.Choice(bloodgroup, dtmf, true, "exact", "AvailableUnitsAPI",
							grammarInfo, true);
					choices.add(choice);
