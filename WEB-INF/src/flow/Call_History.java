...
import org.util.ConnectionPooling;
 ...
 * Orchestration Designer at: 2023-FEB-13 04:22:20 PM
 */
public class Call_History extends com.avaya.sce.runtime.Data {
	...
	/**
	 * Default constructor Last generated by Orchestration Designer at: 2023-FEB-13
	 * 04:22:20 PM
	 */
	public Call_History() {
	...
	public void requestBegin(SCESession mySession) {
		...
		mySession.getVariableField(IProjectVariables.CALL__HISTORY, IProjectVariables.CALL__HISTORY_FIELD_ENDDATE)
				.setValue(end);

		try {
			mySession.getVariableField(IProjectVariables.CALL__HISTORY, IProjectVariables.CALL__HISTORY_FIELD_DURATION)
					.setValue(Duration(mySession));
		...
		try {
			...
			mySession.getVariableField(IProjectVariables.CALL__HISTORY, IProjectVariables.CALL__HISTORY_FIELD_IP)
					.setValue(ip);
		} catch (UnknownHostException e) {
			TraceInfo.trace(ITraceInfo.TRACE_LEVEL_ERROR, "Error in IP address fetching" + e, mySession);
		}

		String flowname = "Blood Bank";
		String ucid = mySession.getVariableField(IProjectVariables.SESSION, IProjectVariables.SESSION_FIELD_UCID)
				.getStringValue();
		String clid = mySession.getVariableField(IProjectVariables.SESSION, IProjectVariables.SESSION_FIELD_ANI)
				.getStringValue();
		...
		String sessionId = mySession
				...
				.getStringValue();
		String startdate = mySession
				.getVariableField(IProjectVariables.CALL__HISTORY, IProjectVariables.CALL__HISTORY_FIELD_STARTDATE)
				.getStringValue();
		String enddate = mySession
				.getVariableField(IProjectVariables.CALL__HISTORY, IProjectVariables.CALL__HISTORY_FIELD_ENDDATE)
				.getStringValue();
		String duration = mySession
				.getVariableField(IProjectVariables.CALL__HISTORY, IProjectVariables.CALL__HISTORY_FIELD_DURATION)
				.getStringValue();
		String exitlocation = mySession
				.getVariableField(IProjectVariables.CALL__HISTORY, IProjectVariables.CALL__HISTORY_FIELD_EXITNODE)
				.getStringValue();
		String exitreason = mySession
				.getVariableField(IProjectVariables.CALL__HISTORY, IProjectVariables.CALL__HISTORY_FIELD_EXITREASON)
				.getStringValue();
		String appip = mySession
				.getVariableField(IProjectVariables.CALL__HISTORY, IProjectVariables.CALL__HISTORY_FIELD_IP)
				.getStringValue();
		TraceInfo.trace(ITraceInfo.TRACE_LEVEL_INFO,"Flowname:"+flowname+" UCID:"+ucid+" CLID:"+clid+" DNIS:"+dnis+" SESSid:"+sessionId+" STdate:"+startdate+" EDdate:"+enddate+" DUR:"+duration+" EXIT:"+exitlocation+" ENDres:"+exitreason+" AppIP:"+appip, mySession);

		System.out.println(flowname+" "+ucid+" "+dnis+" "+sessionId+" "+startdate+" "+enddate+" "+duration+" "+exitlocation+" "+exitreason+" "+appip);
		ConnectionPooling cs = new ConnectionPooling();
