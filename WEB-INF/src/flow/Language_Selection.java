...
public class Language_Selection extends com.avaya.sce.runtime.Menu {
	 ...
	 * Last generated by Orchestration Designer at: 2023-JAN-20  10:44:42 AM
	...
	public java.util.Collection getChoices(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		choice = new com.avaya.sce.runtime.Choice("English", "1", true, "exact", "RegionSelection", grammarInfo, true);
		list.add(choice);
		...
		choice = new com.avaya.sce.runtime.Choice("Tamil", "2", true, "exact", "RegionSelection", grammarInfo, true);
		list.add(choice);
