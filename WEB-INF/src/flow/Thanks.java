 ...
 * Last generated by Orchestration Designer at: 2023-FEB-16  05:59:47 PM
 */
public class Thanks extends com.avaya.sce.runtime.Form {
	...
	public java.util.Collection getPrompts(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		list.add(new com.avaya.sce.runtime.PromptRefInfo("Thanks", ""));
	...
	public void updatePrompts(Collection prompts, SCESession mySession) {
		...
		p.add(1, new com.avaya.sce.runtime.PhraseVariableElement("AudioURLs:Thanks",com.avaya.sce.runtime.PhraseVariableElement.Type.AUDIO_URL, false));
		prompts.add(p);
